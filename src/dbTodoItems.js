...
if (storageAvailable("localStorage")) {
    if ("todoDB" in localStorage) {
        ...
        todoDB.push(
            new itemTodo(
                projectIds[0],
                "Sample Todo Item No.1",
                "This is a sample todo no.1 item for demonstration purposes with DUE date.",
                formatDateToISO(
                    generateCustomDateFromNow(1, randomIntFromInterval(1, 999))
                ),
                1,
                false
            )
        ...
        todoDB.push(
            new itemTodo(
                projectIds[0],
                "Sample Todo Item No.2",
                "This is a sample todo no.2 item for demonstration purposes with DUE TODAY date.",
        ...
        todoDB.push(
            new itemTodo(
                projectIds[0],
                "Sample Todo Item No.3",
                "This is a sample todo no.3 item for demonstration purposes with OVERDUE date.",
                formatDateToISO(
                    generateCustomDateFromNow(-1, randomIntFromInterval(1, 999))
                ),
                3,
